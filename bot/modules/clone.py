...
clone_handler = CommandHandler(BotCommands.CloneCommand, BotCommands.GdToTCommand, cloneNode, filters=CustomFilters.authorized_chat | CustomFilters.authorized_user, run_async=True)
